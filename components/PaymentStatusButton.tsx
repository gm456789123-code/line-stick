...
export default function PaymentStatusButton({ orderId, token, currentStatus }: Props) {
  ...
  return (
    <>
      {showBillPopup ? (
        <div className={styles.billBackdrop} role="dialog" aria-modal="true">
          <div className={styles.billModal}>
            <p className={styles.billKicker}>บันทึกเลขบิลไว้</p>
            <h5 className={styles.billTitle}>ส่งสลิปสำเร็จ</h5>
            <p className={styles.billText}>
              เลขบิลของคุณคือ <strong>#{orderId}</strong>
            </p>
            <p className={styles.billWarning}>*โปรดเก็บหลักฐานเลขสั่งซื้อเพื่อติดตามออเดอร์</p>
